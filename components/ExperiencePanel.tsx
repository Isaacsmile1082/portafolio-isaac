    ...
    <Box>
      <VerticalTimeline>
        ...
        >
          ...
          <h4 className="vertical-timeline-element-subtitle">Estee lauder Companies</h4>
          <p>
            Frontend, Nodejs and CMS
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          ...
          date="2021 november - 2023 march"
        >
          <h3 className="vertical-timeline-element-title">Middle Frontend Engineer</h3>
          <h4 className="vertical-timeline-element-subtitle">Agile Engine Indeed</h4>
          <p>
            Responsive, Accesibility, Integration test, React, Unittesting 
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p>
            Authentication, Dashboard, Landings, Animations, Blogs
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
           className="vertical-timeline-element--work"
        ...
        >
          ...
          <p>
            Login screens, Global authentication, Design
          </p>
        </VerticalTimelineElement>
      </VerticalTimeline>
    </Box>
